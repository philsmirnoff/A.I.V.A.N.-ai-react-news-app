...
intent('What does this app do?', 'What can I do here?',
    reply('This is Aivan, artificial intelligence voice assistant news app'));



const API_KEY = '36c82a3f1ca1467884f7459eb8f43ff3';
let savedArticles = [];
...
question(
    '(Who|What) are you',
    reply(
        'I\'m Aivan, artificial intelligence voice assistant news app. What can I help you with?',
    ),
);
...
question(
    'My name is $(NAME)',
    reply('(Nice to meet you|Hi|Hello) $(NAME) (I\'m Aivan|my name is Aivan|)'),
);
...
question(
    ...
    'Who are you?',
    reply(
        '(My name is|It\'s) Aivan, what\'s yours?',
        follow(
